...
def parse_wav_scp(wav_scp_path):
    ...
    with open(wav_scp_path, 'r') as f:
        for line in f:
            ...
            elif dataset_name == "fileid":
                dataset_name = "urgent_simu"
...
def main():
    ...
    wav_scp_path = "/work/nvme/bbjs/shi3/evaluation/espnet/egs2/universa_unite/uni_versa1/data/enhancement_simu_base/wav.scp"
    output_dir = "feature_10k"
