...
penalty=0.4
latency_metrics="StartOffset EndOffset ATD"
...
output="$exp/s2st${tag}_beam${beam_size}_ctc${ctc_weight}_pen${penalty}_chunk${sim_chunk_length}_drd${disable_repetition_detection}_tokdelay${token_delay}_wordlist${use_word_list}_v2"
