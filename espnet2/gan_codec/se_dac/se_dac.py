...
class SEDAC(AbsGANCodec):
    ...
    def __init__(
        ...
        # Define modules
        self.generator = SEDACGenerator(**generator_params)
    ...
    def _forward_generator(
        ...
        **kwargs,
        ...
        if is_quantizer_active:
            loss = loss + enhanced_adv_loss + enhanced_quantization_loss + enhanced_reconstruct_loss
...
class SEDACGenerator(nn.Module):
    ...
    def forward(
        ...
        enhanced_encoder_out = self.encoder(x)
